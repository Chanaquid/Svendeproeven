...
export function getAvailabilityLabel(availability: ItemAvailability): string {
  switch (availability) {
    case ItemAvailability.Available: return 'Available';
    case ItemAvailability.OnRent: return 'On rent';
    case ItemAvailability.Unavailable: return 'Unavailable';
...
export function getAvailabilityClass(availability: ItemAvailability): string {
  switch (availability) {
    case ItemAvailability.Available: return 'available';
    case ItemAvailability.OnRent: return 'rent';
    case ItemAvailability.Unavailable: return 'unavailable';
    default: return '';
  }
}
