...
export class UserReviewService {
  ...
  createReview(dto: CreateUserReviewDto): Observable<ApiResponse<UserReviewDto>> {
    return this.http.post<ApiResponse<UserReviewDto>>(this.baseUrl, dto);
  }

  // PATCH /api/user-reviews/{id}
  updateReview(id: number, dto: UpdateUserReviewDto): Observable<ApiResponse<UserReviewDto>> {
    return this.http.patch<ApiResponse<UserReviewDto>>(`${this.baseUrl}/${id}`, dto);
  }

  // GET /api/user-reviews/{id}
  getById(id: number): Observable<ApiResponse<UserReviewDto>> {
    return this.http.get<ApiResponse<UserReviewDto>>(`${this.baseUrl}/${id}`);
  }
  ...
  getRatingSummary(userId: string): Observable<ApiResponse<UserRatingSummaryDto>> {
  ...
  getMyGivenReviews(
    ...
    return this.http.get<ApiResponse<PagedResult<UserReviewListDto>>>(`${this.baseUrl}/my/given`, {
      params: { ...(filter || {}), ...request } as any,
    });
  }
  ...
  getAll(
    ...
    return this.http.get<ApiResponse<PagedResult<UserReviewDto>>>(this.baseUrl, {
      params: { ...(filter || {}), ...request } as any,
    });
  }

  // POST /api/user-reviews/admin
  adminCreateReview(dto: AdminCreateUserReviewDto): Observable<ApiResponse<UserReviewDto>> {
    return this.http.post<ApiResponse<UserReviewDto>>(`${this.baseUrl}/admin`, dto);
  }
