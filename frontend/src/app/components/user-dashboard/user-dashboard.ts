...
export class UserDashboard implements OnInit {
  ...
  tabs = [
    { key: 'items' as const, label: 'Mine genstande' },
    { key: 'loans' as const, label: 'Lejeaftaler' },
    { key: 'score' as const, label: 'Scorehistorik' },
  ];
  ...
  documentTypes = [
    { label: '🪪 Nationalt ID', value: 'NationalId' },
    { label: '🛂 Pas', value: 'Passport' },
    { label: '🚗 Kørekort', value: 'DrivingLicense' },
  ];
  ...
  this.stats = [
    { icon: '📦', value: this.totalActiveItems, label: 'Aktive genstande' },
    { icon: '🤝', value: activeLoans, label: 'Aktive lejeaftaler' },
    { icon: '✅', value: completedLoans, label: 'Afsluttede lejeaftaler' },
    { icon: '💸', value: totalFinesPaid, currency: 'kr', label: 'Betalte bøder i alt' },
  ];
  }
